<?php 
	...
	$q="select *,count(*) as count from `match` where match_id=64 group by match_id order by match_time";
	$qu=mysql_query($q);
	?>
	<br>
	<?php
	...
	<?php } 
		...
		{
		?>
			<h1 align="center"style="color:white;background-color:black">NO FINAL YET</h1>
<?php	}?>
			<br><br>